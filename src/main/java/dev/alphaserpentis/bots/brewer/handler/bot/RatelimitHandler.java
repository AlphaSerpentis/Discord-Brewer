...
public class RatelimitHandler {
    ...
    public int getRemainingRunsForServer(long guildId, @NonNull ServiceType serviceType) {
        EnumMap<ServiceType, Integer> serverRemainingRuns = serverRemainingRunsMap.getOrDefault(
                guildId,
    ...
    public int getRemainingRunsForUser(long userId, @NonNull ServiceType serviceType) {
        EnumMap<ServiceType, Integer> userRemainingRuns = userRemainingRunsMap.getOrDefault(
                userId,
                new EnumMap<>(ServiceType.class)
        );
